...
public sealed class ListeningSystem : EntitySystem
{
    ...
    public void PingListeners(EntityUid source, string message, bool isWhisper)
    {
        ...
        var obfuscatedEv = !isWhisper ? null : new ListenEvent(_chat.ObfuscateMessageReadability(message), source); var query = EntityQueryEnumerator<ActiveListenerComponent, TransformComponent>();
