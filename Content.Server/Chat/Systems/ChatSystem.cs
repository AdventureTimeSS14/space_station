...
public sealed partial class ChatSystem : SharedChatSystem
{
        ...
        )
    {
        ...
        var ev = new EntitySpokeEvent(source, message, null, false, language, originalMessage);
        ...
        )
    {
        ...
        var ev = new EntitySpokeEvent(source, message, channel, true, language, originalMessage);
        RaiseLocalEvent(source, ev, true);
        if (!hideLog)
            if (originalMessage == message)
            {
    ...
    private void SendLOOC(EntityUid source, ICommonSession player, string message, bool hideChat)
    {
        ...
        SendInVoiceRange(ChatChannel.LOOC, name, message, wrappedMessage,
            ...
            player.UserId,
            languageOverride: LanguageSystem.Universal); _adminLogger.Add(LogType.Chat, LogImpact.Low, $"LOOC from {player:Player}: {message}");
    }
...
public sealed class EntitySpokeEvent : EntityEventArgs
{
    ...
    public EntitySpokeEvent(EntityUid source, string message, RadioChannelPrototype? channel, bool isWhisper, LanguagePrototype language, string originalMessage)
    {
        Source = source;
        Message = message;
