...
namespace Content.Client.ADT.Chemistry.UI
{
    ...
    public sealed partial class ReagentAnalyzerWindow : DefaultWindow
    {
        ...
        public event Action<GUIMouseHoverEventArgs, ReagentButton>? OnReagentButtonMouseEntered;
        public event Action<GUIMouseHoverEventArgs, ReagentButton>? OnReagentButtonMouseExited;
