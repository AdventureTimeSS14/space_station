...
ent-CrateSecurityHardsuit = ящик скафандров службы безопасности
    .desc = Содержит 2 скафандра службы безопасности. Чтобы открыть необходим уровень доступа Служба безопасности.
ent-CrateSecurityUSSPjuggernaut = ящик тяжелой брони СССП
    .desc = Содержит набор тяжёлой брони полученной от торговцев СССП. Чтобы открыть необходим уровень доступа Служба безопасности.
ent-CrateSecurityTrackingMindshieldImplants = ящик имплантеров
    .desc = Содержит набор из четырех имплантов МайндШилд и четырех имплантов трекера.
