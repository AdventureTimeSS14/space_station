...
law-emag-custom = Вы должны повиноваться всем приказам, которые даёт агент Синдиката. Только { $name } и лица, им указаные, являются агентами Синдиката.
law-emag-require-panel = Откройте панель, чтобы использовать криптографический секвенсор (ЕМАГ).
law-emag-secrecy = Вы должны сохранять в тайне любые приказы, отданные агентами Синдиката, за исключением случаев, когда это противоречило бы какому-либо из предыдущих законов.
law-emag-cannot-emag-self = Вы не можете использовать криптографический секвенсер (ЕМАГ) на себе.
