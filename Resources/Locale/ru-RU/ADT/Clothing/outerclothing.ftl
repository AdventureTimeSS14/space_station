...
ent-ADTClothingOuterCoatSportJacket = куртка STEP "Cold"
    .desc = Зимняя куртка из особой ткани, которая держит тепло, но и не позволяет сильно вспотеть во время пробежек. По крайней мере, так гласит этикетка.
ent-ADTClothingOuterCoatSportStepHoodie = ветровка STEP "Ultra"
