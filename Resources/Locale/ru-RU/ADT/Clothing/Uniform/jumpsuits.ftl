...
ent-ADTJumpskirtSwimwearBlue = голубой купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearGold = золотой купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearGreen = зеленый купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearOrange = оранжевый купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearPurple = фиолетовый купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearRed = красный купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearWhite = белый купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }

ent-ADTJumpskirtSwimwearYellow = желтый купальник
    .desc = Отлично подойдет для наслаждения морем, пусть и не настоящим. Ну или для пробежки через всю станцию, если вы проиграли спор.
    .suffix = { "" }
...
ent-ADTClothingUniformSportSuit = костюм STEP "Cold"
    .desc = Спортивный зимний костюм для.. вы угадали, зимних пробежек.
ent-ADTClothingUniformSportRoseSuit = костюм STEP "Rose"
    .desc = Ярко-розовый тренировочный костюм. 
...
ent-ADTClothingUniformPathologistAltSuit = чёрный костюм патологоанатома
    .desc = Лёгкий комбинезон для работника морга. Более угрюмая версия.
    .suffix = { "" } 

ent-ADTClothingUniformPathologistAltSkirt = чёрная юбка-костюм патологоанатома
