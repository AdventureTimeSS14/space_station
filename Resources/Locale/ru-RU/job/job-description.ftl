...
job-description-brigmedic = Лечите сотрудников СБ, изготавливайте для этого медикаменты, держите лазарет и бриг в чистоте и конечно постарайтесь не допустить смерти заключенных в камерах брига.
job-description-magistrat = Обеспечьте должное исполнение КЗ на станции, проводите судебные разбирательства, выносите справедливые приговоры и контролируйте работу АВД.
job-description-paramedic = Следите за жизненными показателями экипажа и спасаете людей вне мед отдела!
job-description-virusolog = Диагностируйте и лечите вирусные инфекции, создавайте вакцины и конечно помещайте заражённых в карантин!
...
job-description-senior-researcher = Обучайте новых ученых основам производста печати предметов, исследования артефактов и аномальных объектов.
...
job-description-senior-engineer = Обучайте новых инженеров технике безопасности, основам работы генератора ДАМ, настройке атмосферы и электроснабжения станции.
