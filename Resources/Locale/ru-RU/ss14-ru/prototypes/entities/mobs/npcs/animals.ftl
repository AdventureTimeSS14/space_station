...
ent-MobBee = пчела
    .desc = Приятно, когда она есть, но нельзя построить цивилизацию на фундаменте из одного только меда.
ent-MobAngryBee = пчела
    .desc = Какая милая пчелка. О нет, она выглядит злой и хочет мою пиццу.
    .suffix = Злой
ent-MobChicken = курица
    .desc = Раньше яйца была динозавром!
...
ent-MobGlockroach = глоклещ
    .suffix = АДМЕМЫ
    .desc = Если успеешь прочитать описание, то ты молодец. А пока - БЕГИ, СУКА, БЕГИ!!!
...
ent-MobMonkeyChangeling = обезьяна
    .desc = Новая церковь неодарвинистов действительно верит, что КАЖДОЕ животное произошло от обезьяны. На вкус они как свинина, а убивать их весело и приятно.
ent-ChangelingHeadslug = червь генокрада
    .desc = Отвратительное нечто, оставшееся от генокрада. Почему вы просто стоите и смотрите?! Убейте это, пока не поздно!
    .suffix = Генокрад
ent-ChangelingHeadslugSpread = червь генокрада
    .desc = Отвратительное нечто, оставшееся от генокрада. Почему вы просто стоите и смотрите?! Убейте это, пока не поздно!
    .suffix = Распространитель
ent-ChangelingHeadslugMidround = червь генокрада
    .desc = Отвратительное нечто, оставшееся от генокрада. Почему вы просто стоите и смотрите?! Убейте это, пока не поздно!
    .suffix = Гостроль
ling-round-end-agent-name = червь генокрада
ent-MobKobold = кобольд
    .desc = Двоюродные братья унатхов, сливающиеся со своей средой обитания и являющиеся такими же противными, как макаки. Они готовы вырвать ваши волосы и заколоть вас до смерти.
