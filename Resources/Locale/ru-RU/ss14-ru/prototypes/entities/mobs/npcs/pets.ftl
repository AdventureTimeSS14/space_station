...
ent-MobCrabAtmos = Тропико
    .desc = Доблестный и крепкий защитник Атмосии. Viva el Frezon!
ent-MobCorgiIanPup = щенок Иан
    .desc = Любимый щеночек корги. Ути какой хороший!
    .suffix = AI
ent-MobPossumPoppy = Поппи
    .desc = Это опоссум, маленькое сумчатое животное, питающееся падалью. На него надеты соответствующие средства индивидуальной защиты.
    .suffix = AI
ent-MobBreadDog = Хлебопёс
    .desc = Где-то однажды появился на свет. С лаем из печки зверь, каких нет. И тут же сбежал, оставив вопрос. Хлебо-собачий малыш хлебопёс. Хлебопёс. Хлебоп-ё-ё-ё-с. Единственный в мире малыш хлебопёс.
ent-MobCatCake = Тортокот
    .desc = Где-то однажды появился на свет. С мяуканьем бисквитный зверь, каких нет. И тут же сбежал, оставив вопрос. Торто-кошачий малыш тортокот. Тортокот. Торток-о-о-о-т. Единственный в мире малыш тортокот.
