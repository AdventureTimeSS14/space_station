...
ent-ClothingHandsGlovesJanitor = резиновые перчатки
    .desc = Высококачественные скрипучие резиновые перчатки,  самое то для уборки!
ent-WeaponGauntletGorilla = боевые перчатки Г.О.Р.И.Л.Л.А.
    .desc = Робастное исследовательское оборудование. Для использования требует ядро аномалии. Один удар может далеко отбросить аномальные объекты.
