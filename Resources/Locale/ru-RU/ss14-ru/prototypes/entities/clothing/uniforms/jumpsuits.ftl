...
ent-ClothingUniformJumpsuitBartender = комбинезон бармена
...
ent-ClothingUniformJumpsuitBartenderPurple = фиолетовый комбинезон бармена
...
ent-ClothingUniformJumpsuitWarden = комбинезон смотрителя
...
ent-ClothingUniformJumpsuitERTEngineer = комбинезон инженера ОБР
    .desc = Специальный костюм, созданный для элитных инженеров Центкома.
ent-ClothingUniformJumpsuitERTJanitor = комбинезон уборщика ОБР
    .desc = Специальный костюм, созданный для элитных уборщиков Центкома.
ent-ClothingUniformJumpsuitERTLeader = комбинезон лидера ОБР
    .desc = Специальный костюм, созданный для самой элиты Центкома.
ent-ClothingUniformJumpsuitERTMedic = комбинезон медика ОБР
    .desc = Специальный костюм, созданный для элитных медиков Центкома.
ent-ClothingUniformJumpsuitERTSecurity = комбинезон офицера безопасности ОБР
...
ent-ClothingUniformJumpsuitCasualBlue = повседневный синий комбинезон
    .desc =  Свободная поношенная синяя рубашка с серыми брюками, идеально подходящая для тех, кто хочет расслабиться.
ent-ClothingUniformJumpsuitCasualPurple = повседневный фиолетовый комбинезон
    .desc = Свободная поношенная фиолетовая рубашка с серыми брюками, идеально подходящая для тех, кто хочет расслабиться.
ent-ClothingUniformJumpsuitCasualRed = повседневный красный комбинезон
     .desc = Свободная поношенная красная рубашка с серыми брюками, идеально подходящая для тех, кто хочет расслабиться.
ent-ClothingUniformJumpsuitCurator = практичный костюм
    .desc = Это разумно. Слишком разумно...
ent-ClothingUniformJumpsuitFamilyGuy = обычная одежда
    .desc = Заставит вас вспомнить, как вы делали что-то забавное.
ent-ClothingUniformJumpsuitGladiator = форма гладиатора
    .desc = Создана для настоящих гладиаторов (или Ходячих в пепле).
