...
ent-ClothingOuterCoatLabSeniorResearcher = лабораторный халат ведущего научного сотрудника
    .desc = Костюм, защищающий от незначительных разливов химикатов. Имеет фиолетовый воротник и отделку запястий.
ent-ClothingOuterCoatLabSeniorPhysician = лабораторный халат старшего врача
    .desc = Костюм, защищающий от незначительных разливов химикатов. Имеет голубые рукава и оранжевую окантовку на талии.
