...
ent-ClothingOuterHardsuitSanta = скафандр Санты
    .desc = Праздничный, жизнерадостный скафандр, который защитит веселого Санты во время катания на санях в космосе. Обеспечивает некоторую устойчивость к столкновениям с астероидами.
ent-ClothingHeadHelmetHardsuitSanta = шлем скафандра Санты
    .desc = Праздничный шлем от скафандра, который защищает Санту от воздействия окружающей среды с низким давлением.
