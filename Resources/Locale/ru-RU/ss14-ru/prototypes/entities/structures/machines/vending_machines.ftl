...
ent-SmartFridge = Умный холодильник
    .desc = Охлаждаемое хранилище для складирования лекарств и химикатов.
ent-VendingMachineChemicalsSyndicate = СиндиХимкоМат
    .desc = Надеюсь, химикаты внутри не из выжатых агентов.
...
ent-VendingMachineCuraDrobe = БиблиоШкаф
    .desc = Торговый автомат, выдающий одежду и принадлежности для библиотекарей.
