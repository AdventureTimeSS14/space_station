...
ent-SignJanitor = знак "уборка"
    .desc = Знак, указывающий на коморку уборщика.
ent-JanitorServiceLight = сервисная лампа уборщика
    .desc = Настенная табличка для уборщика. Если индикатор мигает, требуются услуги уборщика.