...
ent-ADTPosterWatchOutChem = Бойтесь химикатов!
    .desc = Постер, предупреждающий вас (или рекламирующий) особые химикаты агентов Синдиката.

ent-ADTPosterPanem = Хлеба и зрелищ!
    .desc = Постер, рекламирующий подпольные бои насмерть в дальних уголках коридоров станции.

ent-ADTPosterPapersPlease = Бумаги, пожалуйста!
    .desc = Плакат, призывающий персонал NanoTrasen держать при себе идентификационные карточки и правильно заполнять документы.
...
ent-ADTPosterWorkUnderWay = Работа ведется
    .desc = Напоминание о постоянной деятельности инженерного отдела.

ent-ADTPosterPlasmaMan = Плазма(мены)
    .desc = Реклама новой линейки адаптационного снаряжения для плазмаменов.
