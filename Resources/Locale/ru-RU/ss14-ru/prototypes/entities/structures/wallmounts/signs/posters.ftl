...
ent-PosterLegitCarpMount = Настенный карп
    .desc = Carpe diem!
ent-PosterLegitSafetyMothDelam = Опасливый Ниан - Меры предосторожности при расслоении
    .desc = Этот информационный постер использует Опасливый Ниан™, чтобы посоветовать сотрудникам станции спрятаться в шкафу при расслоении Кристала суперматерии во избежание галлюцинаций. Эвакуация станции может быть наилучшим решением.
ent-PosterLegitSafetyMothEpi = Опасливый Ниан - Эпинефрин
    .desc = Этот информационный постер использует Опасливый Ниан™ чтобы сообщить сотруднику станции о необходимости помочь раненым/погибшим членам экипажа с помощью экстренных медипенов. "Предотвратите гниение коллеги с помощью этого простого трюка!"
ent-PosterLegitSafetyMothHardhat = Опасливый Ниан - Каски
    .desc = Этот информационный постер использует Опасливый Ниан™ чтобы посоветовать сотруднику станции надевать каски в опасных местах. "Это как лампа для твоей головы!"
ent-PosterLegitSafetyMothMeth = Опасливый Ниан - Метамфетамин
    .desc = Этот информационный постер использует Опасливый Ниан™ чтобы сообщить сотруднику станции о необходимости наличия разрешения Главного Врача на варку метамфетамина. "Поддерживайте заданную температуру и никогда не превышайте ее!" ...А вообще тебе вообще не следовало этим заниматься.
ent-PosterLegitSafetyMothPiping = Опасливый Ниан - Piping
    .desc = Этот информационный постер использует Опасливый Ниан™ чтобы напомнить атмосферным техникам, какие типы трубо следует использовать. "Трубы, а не насосы! Правильное размещение труб предотвращает снижение производительности станции!"
