...
ent-SyndiAgentPDA = КПК агента синдиката
    .desc = Используйте его тогда, когда надоело лечить обычных агентов Синдиката и хочется чего-то посерьезней. Например, Ядерных Оперативников!