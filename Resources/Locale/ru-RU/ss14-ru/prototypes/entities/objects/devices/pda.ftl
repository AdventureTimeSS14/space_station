...
ent-ParamedicPDA = КПК парамедика
    .desc = Блестящий и стерильный. Имеет встроенный анализатор здоровья.
    .suffix = { "" }
ent-PramedicPDA = КПК парамедика
    .desc = Блестящий и стерильный. Имеет встроенный анализатор здоровья.
    .suffix = { "" }
...
ent-ADTBlueShieldOfficerPDA = КПК офицера "синего щита"
    .desc = Блестящий, он пахнет защитой.
    .suffix = { "" }
