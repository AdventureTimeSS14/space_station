...
ent-AnomalyVesselExperimentalCircuitboard = экспериментальный сосуд аномалий (машинная плата)
    .desc = Печатная плата экспериментальной версии сосуда для аномалий.