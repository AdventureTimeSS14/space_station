...
ent-EmergencyFunnyOxygenTank = веселый аварийный кислородный баллон
    .desc = Легкий переносной баллон для чрезвычайных ситуаций. Содержит очень мало кислорода и веселящего газа. Конечно же предназначен только для выживания.
ent-EmergencyFunnyOxygenTankFilled = веселый аварийный кислородный баллон
    .desc = Легкий переносной баллон для чрезвычайных ситуаций. Содержит очень мало кислорода и веселящего газа. Конечно же предназначен только для выживания.
    .suffix = Полный
ent-DoubleEmergencyNitrogenTank = двойной аварийный азотный баллон
    .desc = Высококлассный двухбаллонный резервуар аварийного жизнеобеспечения для видов, дышащих азотом. Вмещает приличное для своих небольших размеров количество азота.
