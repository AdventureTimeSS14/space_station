...
ent-DrinkMelonLiquorBottleFull = арбузный ликёр Эмеральдин
    .desc = Бутылка 23-градусного арбузного ликёра Эмеральдин. Сладкий и легкий.
...
ent-DrinkChampagneBottleFull = шампанское
    .desc = Премиальное игристое вино
ent-DrinkMopwataBottleRandom = бутылочка воды из под швабры
    .desc = Запотевшая коричневая бутылка с выцветшей этикеткой, на которой изображена швабра. В ней много тёмной и старой... жидкости.
