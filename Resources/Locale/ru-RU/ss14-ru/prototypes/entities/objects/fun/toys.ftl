...
ent-PlushieArachind = плюшевый арахнид
    .desc = Очаровательная мягкая игрушка, напоминающая паука. На ощупь она шелковистая..
ent-PlushiePenguin = плюшевый пингвин
    .desc = Они любят смешно скользить по льду.
ent-NewtonCradle = колыбель ньютона
    .desc = Устройство, с помощью которого скучающие бюрократы напоминают себе, что время еще не остановилось. Содержит гравитацию.
...
ent-PlushieHolocarp = плюшевый голокарп
    .desc = Голографическая мягкая игрушка, напоминающая главного врага науки - голокарпа.
