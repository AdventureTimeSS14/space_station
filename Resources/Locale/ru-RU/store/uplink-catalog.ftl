...
uplink-speedloader-357-name = Спидлоадер (.357AP)
uplink-speedloader-magnu-desc = Спидлоадер с патронами .357AP, способными пробить совершенно любую броню. Совместим с револьвером "Питон".
...
uplink-death-acidifier-implant-name = имплант посмертного растворения
uplink-death-acidifier-implant-desc = Полностью растворяет пользователя и его снаряжение при использовании или после смерти.
...
uplink-hardsuit-syndieelite-desc = Элитная версия кроваво-красного скафандра с повышенной подвижностью и огнестойкостью. Собственность Марадёров Горлакса.
# Pointless
...
ADTuplink-chainsaw-name = Бензопила
ADTuplink-chainsaw-desc = Большой агрегат для расчистки своих врагов.