...
admin-smite-super-bonk-description = Бьет цель головой по каждому столику на станции и за ее пределами.
admin-smite-super-bonk-lite-description= Бьет цель головой по каждому столику на станции и за ее пределами пока та не умрёт.admin-smite-terminate-description = Создает роль Терминатора с целью на устранение этого персонажа.
